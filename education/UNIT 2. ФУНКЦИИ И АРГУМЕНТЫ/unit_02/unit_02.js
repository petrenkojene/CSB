...
function t1(min, max) {
  ...
  document.querySelector(".out-1").innerHTML = arg;
}
...
function t2(min, max, block) {
  let arg1 = Math.floor(Math.random() * (max - min + 1) + min);
  out2.innerHTML = arg1;
}
...
function t3(min = 0, max = 100) {
  //   min = 0;
  //   max = 100;
  let arg2 = Math.floor(Math.random() * (max - min + 1) + min);
  document.querySelector(".out-3").innerHTML = arg2;
  console.log(arg2);
}
...
function t4(a, b, c) {
  ...
  document.querySelector(".out-4").innerHTML = currentNumber;
}
...
function t5(a, b, c = 0) {
  ...
  document.querySelector(".out-5").innerHTML = currentNumber;
}
...
document.querySelector(".b-6").addEventListener("click", function () {
  t6([99, 44, 55, 66, 4, 6, "hello", 22], out6);
});
...
function t8(block, text) {
  let x = text.trim();
  console.log(x);
  document.querySelector(".out-8").innerHTML = x.toUpperCase();
}
...
function t9(text = "", block) {
  if (block != undefined) {
    let x = text.trim();
    console.log(x);
    document.querySelector(".out-9").innerHTML = x.toUpperCase();
  }
}
...
function t12(...numbers) {
  let result = 0;
  for (let num of numbers) {
    result += num;
    out12.innerHTML = result;
  }
}
